...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>ContaCoop - Autenticar</title>

        <meta name="description" content="ContaCoop - Autenticar">
        <meta name="author" content="S. Barrenechea">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <label class="css-input switch switch-sm switch-primary">
                                            <input type="checkbox" id="remember" name="remember"><span></span> Recuérdame
                                        </label>
                                    </div>
                                </div>
